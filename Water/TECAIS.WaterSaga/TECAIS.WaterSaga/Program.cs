...
using TECAIS.WaterSaga.StateMachines;
...
namespace TECAIS.WaterSaga
{
    class Program
    {
        static async Task Main(string[] args)
        {
            ...
            var builder = new HostBuilder()
                ...
                .ConfigureServices((hostContext, services) =>
                {
                    ...
                    {
                        cfg.AddSagaStateMachine<WaterSubmissionStateMachine, SubmissionState>()
                            .InMemoryRepository();

                        cfg.UsingRabbitMq(ConfigureBus);
                    });

                    services.AddHostedService<WaterSagaConsoleHostedService>();
        ...
        static void ConfigureBus(IBusRegistrationContext busRegistrationContext, IRabbitMqBusFactoryConfigurator configurator)
        {
            ...
            configurator.ReceiveEndpoint("WaterSaga", e =>
            {
